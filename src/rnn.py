...
from post_cleaning import process_text_s as process_text
import numpy as np
import pickle
...
a = np.array([
    ...
    process_text("I'm the best ewhore in the world, I make so much money ripping people off, buy my packs, they will make you a lot of money, very very quickly")])
print(a)
